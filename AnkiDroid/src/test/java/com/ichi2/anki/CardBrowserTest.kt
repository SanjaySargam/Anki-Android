...
class CardBrowserTest : RobolectricTest() {
    ...
    fun addCardDeckISetIfDeckIsSelected() = runTest {
        ...
        val arguments = addIntent.getBundleExtra(SingleFragmentActivity.FRAGMENT_ARGS_EXTRA)
        IntentAssert.hasExtra(arguments, NoteEditor.EXTRA_DID, targetDid)
    }
    ...
    fun addCardDeckISetIfDeckIsSelectedOnOpen() {
        ...
        val addIntent = b.addNoteIntent
        val arguments = addIntent.getBundleExtra(SingleFragmentActivity.FRAGMENT_ARGS_EXTRA)
        IntentAssert.hasExtra(arguments, NoteEditor.EXTRA_DID, initialDid)
    }
