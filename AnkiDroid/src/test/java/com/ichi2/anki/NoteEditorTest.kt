...
//    }
    ...
    fun copyNoteCopiesDeckId() {
        ...
        val newNoteEditor = openNoteEditorWithArgs(copyNoteBundle, this)
    ...
    fun processTextIntentShouldCopyFirstField() {
        ...
        val editor = openNoteEditorWithArgs(i.extras!!, this, i.action)
        val actual = editor.currentFieldStrings.toList()
    ...
    private fun getNoteEditorAddingNote(from: FromScreen): NoteEditor {
        ...
        return openNoteEditorWithArgs(bundle, this)
    }
    ...
    fun openNoteEditorWithArgs(arguments: Bundle, re: RobolectricTest, action: String? = null): NoteEditor {
        val activity = re.startActivityNormallyOpenCollectionWithIntent(SingleFragmentActivity::class.java, NoteEditor.getIntent(re.targetContext, arguments, action))
