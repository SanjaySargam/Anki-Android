...
class ModelFieldEditor : AnkiActivity(), LocaleSelectionDialogHandler {
    ...
    private var fieldNameInput: FixedEditText? = null
    ...
    */
    private fun addFieldDialog() {
        ...
        fieldNameInput?.let { _fieldNameInput ->
            ...
            _fieldNameInput.focusWithKeyboard()
            _fieldNameInput.setPadding(16, 16, 16, 16)
            AlertDialog.Builder(this).show {
                setView(_fieldNameInput)
    ...
    private fun repositionFieldDialog() {
        ...
        fieldNameInput?.let { _fieldNameInput ->
            ...
            _fieldNameInput.isVerticalScrollBarEnabled = true
            _fieldNameInput.focusWithKeyboard()
            AlertDialog.Builder(this).show {
                setView(_fieldNameInput)
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.NONE)
    @Throws(ConfirmModSchemaException::class)
    fun renameField(fieldNameInput: FixedEditText?) {
