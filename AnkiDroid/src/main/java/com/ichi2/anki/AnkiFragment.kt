...
open class AnkiFragment(@LayoutRes layout: Int) : Fragment(layout), Toolbar.OnMenuItemClickListener {
    ...
    open fun hideProgressBar(view: View) {
    ...
    protected open fun onKeyUp(keyCode: Int, event: KeyEvent): Boolean {
        return false
    }
